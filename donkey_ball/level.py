...
class Level(object):
    ...
    def __init__(self):
        ...
        d3 = RedBlock(100, 200, d_color)
        d4 = RedBlock(100, 250, d_color)
        d5 = RedBlock(100, 300, d_color)
        d6 = RedBlock(100, 350, d_color)
        d7 = RedBlock(175, 350, d_color)
        d8 = RedBlock(250, 350, d_color)
        d9 = RedBlock(300, 300, d_color)
        d10 = RedBlock(300, 250, d_color)
        d11 = RedBlock(300, 200, d_color)
        d12 = RedBlock(300, 150, d_color)
        d13 = RedBlock(250, 100, d_color)
        d14 = RedBlock(175, 100, d_color)

        b1 = WhiteBlock(400, 100, b_color)
        b2 = WhiteBlock(400, 150, b_color)
        b3 = WhiteBlock(400, 200, b_color)
        b4 = WhiteBlock(400, 250, b_color)
        b5 = WhiteBlock(400, 300, b_color)
        b6 = WhiteBlock(400, 350, b_color)
        b7 = WhiteBlock(475, 350, b_color)
        b8 = WhiteBlock(550, 350, b_color)
        b9 = WhiteBlock(600, 300, b_color)
        b10 = WhiteBlock(600, 250, b_color)
        b11 = WhiteBlock(600, 200, b_color)
        b12 = WhiteBlock(600, 150, b_color)
        b13 = WhiteBlock(550, 100, b_color)
        b14 = WhiteBlock(475, 100, b_color)
        b15 = WhiteBlock(475, 225, b_color)
        b16 = WhiteBlock(550, 225, b_color)
